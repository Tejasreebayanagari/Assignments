...
namespace Assignment5
{
    ...
    public class Bank
    {
        ...
        public Bank()
        {
            ...
            Acut_Number = Console.ReadLine();
            Console.WriteLine("Enter the Account holder Name :");
            Acut_Name = Console.ReadLine();

            Console.WriteLine($"The Account details is : AccountNum {Acut_Number}, Acount Namer {Acut_Name}, Amount is {Amount}");
